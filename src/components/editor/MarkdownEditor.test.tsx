...
describe('MarkdownEditor', () => {
  ...
  it('should use placeholder when value is empty', () => {
    ...
    render(<MarkdownEditor value="" onChange={() => {}} placeholder={placeholder} />);
  ...
  it('should call onKeyDown callback', async () => {
    ...
    render(<MarkdownEditor value="" onChange={() => {}} onKeyDown={mockOnKeyDown} />);
  ...
  it('should call onSelect callback', () => {
    ...
    render(<MarkdownEditor value="test content" onChange={() => {}} onSelect={mockOnSelect} />);
  ...
  it('should apply custom className', () => {
    render(<MarkdownEditor value="" onChange={() => {}} className="custom-editor" />);

...
describe('EditorPanel', () => {
  ...
  it('should call onChange callback when content changes', async () => {
    ...
    render(<EditorPanel content="" callbacks={{ onChange: mockOnChange }} />);
  ...
  it('should update stats when content changes', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByTestId('stats-characters')).toHaveTextContent(
        '23 字元'
      );
  ...
  it('should call onSave callback when save action is triggered', async () => {
    ...
    render(
      <EditorPanel content="test content" callbacks={{ onSave: mockOnSave }} />
    );
  ...
  it('should clear modified indicator after save', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.queryByTestId('modified-indicator')
